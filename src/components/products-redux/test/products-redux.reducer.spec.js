...
describe('productsReduxReducer - Unit Test', () => {
    ...
    it('should return initial state when action is undefined', () => {
        ...
        const actual = productsReduxReducer(undefined, action);
    ...
    it('should return current state when unknown action is dispatched', () => {
        ...
        const actual = productsReduxReducer(currentState, action);
    ...
    */
    describe('exampleAction', () => {
        it('should send humans to Mars to recolonise', () => {
            ...
            const actual = productsReduxReducer(stateBefore(), action);
